...
export default function VouchersPage() {
  ...
  const handleToggleStatus = async (voucher: Voucher) => {
    try {
      ...
      toast.success(
        `Voucher ${!voucher.isActive ? "activated" : "deactivated"} successfully`,
      );
      loadVouchers();
    } catch (error) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isEditing && selectedVoucher) {
        await vouchersService.updateVoucher(
  ...
  return (
    <ProtectedRoute>
      <div className="p-6 max-w-7xl mx-auto">
                ...
                <TableBody>
                  {filteredVouchers.map((voucher) => (
                    <TableRow key={voucher.voucherId}>
                      ...
                      <TableCell>
                        <div>{formatCurrency(voucher.minPurchase)}</div>
                      </TableCell>
                      <TableCell>
                        <div
                          className={
                            isExpired(voucher.validUntil) ? "text-danger" : ""
                          }
                        >
                      ...
                      <TableCell>
                        <Chip color={getStatusColor(voucher)} size="sm">
                        ...
                        <Dropdown>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownItem
                              key="toggle"
                              startContent={
                                voucher.isActive ? <EyeOffIcon /> : <EyeIcon />
                              }
        ...
        <Modal isOpen={isOpen} size="2xl" onClose={handleModalClose}>
          <ModalContent>
            <ModalHeader>
        ...
        {/* View Voucher Modal */}
        <Modal isOpen={isViewOpen} size="md" onClose={onViewClose}>
          <ModalContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {formatCurrency(selectedVoucher.minPurchase)}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-default-500">Valid Until</p>
                      <p
                        className={`font-medium ${isExpired(selectedVoucher.validUntil) ? "text-danger" : ""}`}
                      >
