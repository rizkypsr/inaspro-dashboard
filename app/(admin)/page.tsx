            ...
            <CardBody className="gap-4">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">
                      John Doe joined Fantasy League #247
                    </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">
                      Sarah Smith purchased Premium Item
                    </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">
                      Mike Johnson created new league
                    </p>
            ...
            <CardBody className="gap-4">
              <div className="space-y-4">
                <div>
                  ...
                  <Progress color="success" size="sm" value={65} />
                </div>
                <div>
                  <div className="flex justify-between items-center mb-2">
                ...
                <div>
                  ...
                  <Progress color="warning" size="sm" value={45} />
                </div>
                <div>
                  <div className="flex justify-between items-center mb-2">
                  ...
                  <Progress color="success" size="sm" value={72} />
                </div>
              </div>
            </CardBody>
          </Card>
