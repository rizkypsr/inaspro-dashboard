      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-default-500">Monitor and manage customer orders</p>
          </div>
        </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Chip color={getStatusColor(selectedOrder.status)} className="capitalize">
                        {selectedOrder.status}
                      </Chip>
                    </div>
                    <div>
                      <p className="text-sm text-default-500">Payment Status</p>
                      <Chip color={getPaymentStatusColor(selectedOrder.payment.status)} className="capitalize">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {selectedOrder.items.map((item, index) => (
                        <div key={index} className="flex justify-between items-center p-3 bg-default-50 rounded">
                          <div>
                            <p className="font-medium">{item.title}</p>
                            <p className="text-sm text-default-500">Qty: {item.quantity}</p>
                          </div>
                          <div className="text-right">
                            <p className="font-medium">{formatCurrency(item.price * item.quantity)}</p>
                            <p className="text-sm text-default-500">{formatCurrency(item.price)} each</p>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <span>Shipping</span>
                      <span>{formatCurrency(selectedOrder.logistics?.price || 0)}</span>
                    </div>
                    <Divider />
                  ...
                  <div>
                    ...
                    <div className="p-3 bg-default-50 rounded">
                      ...
                      <p>{selectedOrder.shippingAddress.provinceName} {selectedOrder.shippingAddress.postalCode}</p>
                    </div>
                  </div>
                  ...
                  {selectedOrder.logistics?.trackingNumber && (
                    <div>
                      ...
                      <div className="p-3 bg-default-50 rounded">
                        <p className="font-mono">{selectedOrder.logistics.trackingNumber}</p>
                      </div>
                    </div>
                  )}
                </div>
        ...
        {/* Update Order Modal */}
        <Modal isOpen={isUpdateOpen} onClose={onUpdateClose} size="md">
          <ModalContent>
              ...
              <div className="space-y-4">
                <Select
                  ...
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) => 
                    setUpdateData(prev => ({ ...prev, status: e.target.value as OrderStatus }))
                  }
                  isRequired
                >
                  <SelectItem key="pending">Pending</SelectItem>
